...
class LangfuseTracer:
    ...
    def trace_rag_request(
        ...
        try:
            ...
            # Ensure trace is properly closed even if exception occurred
            if trace:
                try:
                    # Trace will be automatically finalized when context exits
                    pass
                except Exception:
                    # Don't let trace cleanup errors propagate
                    pass
