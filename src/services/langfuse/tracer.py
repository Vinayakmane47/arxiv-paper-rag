...
class RAGTracer:
    ...
    def trace_request(self, user_id: str, query: str):
        ...
        try:
            ...
            try:
                ...
                # Don't let tracing errors break the request
                pass
    ...
    def end_request(self, trace, response: str, total_duration: float, metadata: Optional[Dict[str, Any]] = None):
        ...
        try:
            ...
            # Add metadata if provided (e.g., cache_hit, sources, chunks_used)
            if metadata:
